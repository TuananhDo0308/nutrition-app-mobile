      ...
      >
        ...
        >
          <View style={styles.foodInfoContainer}>
            <Text style={[styles.foodName, { color: theme.colors.secondary }]} numberOfLines={2}>
              {item.description}
            </Text>
          ...
          <View style={styles.caloriesContainer}>
            <Text style={[styles.caloriesValue, { color: theme.colors.primary }]}>{amount}</Text>
            <Text style={[styles.caloriesUnit, { color: theme.colors.secondary, opacity: 0.7 }]}>{unit}</Text>
          </View>
        </TouchableOpacity>
      </Animated.View>
    )
  ...
  const renderEmptyList = () => {
    ...
    return (
      ...
      >
        ...
        <Text style={[styles.emptyText, { color: theme.colors.secondary, opacity: 0.7 }]}>No foods found</Text>
        <Text style={[styles.emptySubtext, { color: theme.colors.secondary, opacity: 0.5 }]}>
      ...
      <View style={styles.chartContainer}>
        ...
        >
          <Svg height={radius * 2 + strokeWidth} width={radius * 2 + strokeWidth}>
            ...
            <SvgText x={center} y={center - 10} textAnchor="middle" fill={theme.colors.secondary} fontSize={16}>
              {calculateNutrition.calories}
            </SvgText>
            <SvgText x={center} y={center + 15} textAnchor="middle" fill={theme.colors.secondary} fontSize={14}>
              kcal
            </SvgText>
          </Svg>
        </Animated.View>
    ...
    <View style={styles.tabContentContainer}>
      ...
      {loading ? (
        ...
        >
          ...
          <Text style={[styles.loadingText, { color: theme.colors.secondary, opacity: 0.7 }]}>Finding foods...</Text>
        </Animated.View>
      ) : (
        <FlatList
          data={foods}
          ...
          ListFooterComponent={
            isLoadingMore ? (
              ...
              <Button
                ...
                labelStyle={[styles.loadMoreButtonText, { color: theme.colors.primary }]}
              ...
              >
                ...
                <ScrollView style={styles.drawerScrollView}>
                  <View style={styles.foodHeaderContainer}>
                    <Text style={[styles.selectedFoodName, { color: theme.colors.secondary }]} numberOfLines={2}>
                  ...
                  <View style={styles.nutritionSection}>
                    <Text style={[styles.sectionTitle, { color: theme.colors.secondary }]}>Food Details</Text>
                    {renderPieChart()}
                    <View style={styles.macronutrientsContainer}>
                      <View style={styles.macronutrientItem}>
                        ...
                        <Text style={[styles.macronutrientLabel, { color: theme.colors.secondary }]}>Carbohydrate</Text>
                      ...
                      <View style={styles.macronutrientItem}>
                        ...
                        <Text style={[styles.macronutrientLabel, { color: theme.colors.secondary }]}>Protein</Text>
                        <Text style={[styles.macronutrientValue, { color: theme.colors.secondary }]}>
                      ...
                      <View style={styles.macronutrientItem}>
                        ...
                        <Text style={[styles.macronutrientLabel, { color: theme.colors.secondary }]}>Fat</Text>
                        <Text style={[styles.macronutrientValue, { color: theme.colors.secondary }]}>
                    ...
                    >
                      {submitting ? (
                        ...
                        <>
                          ...
                          />
                          <Text style={[styles.addButtonText, { color: theme.dark ? "#000" : "#fff" }]}>
                            Add to Diet
                          </Text>
                        </>
                      )}
